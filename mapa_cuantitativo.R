...
# Seleccionamos paleta de 6 colores de Color rojo
library(RColorBrewer)
pal <- brewer.pal(6, "OrRd") 
class(pal)

# Mapeo cuantitativo de la población usando método Cuantiles con 6 clases
...
############################## GGPLOT
# Mapa cuantitativo con paquete Ggplot
library(ggplot2)
...
# Mapa cuantitativo usando el paquete Ggmap
library(ggmap)
...
############################## TMAP
# Mapas cuantitativos usando el paquete Tmap y diferentes métodos de clasificación
library(tmap)
